...
public class InventoryMenu {
    ...
    private void handleReportsMenu() {
        ...
        try {
            ...
            switch (reportChoice) {
                case 1:
                    printer.printDefectiveItemList(service.getDefectiveItems());
                    break;
                case 2:
                    categoryReportFlow();
                    break;
                case 3:
                    printer.printOrderReport(service.getProductsToOrder());
                    break;
                case 0: {}
                break;
                default:
    ...
    private void categoryReportFlow() {
        ...
        List<String> categories = Arrays.asList(input.split("\\s*,\\s*"));
        printer.printInventoryReport(service.getProductsByCategories(categories), categories);
    }
